...
// Category
const businessPods = podcast.filter((p) => p.category === 'Business')
const comedyPods = podcast.filter((p) => p.category === 'Comedy')
const educationPods = podcast.filter((p) => p.category === 'Education')
